...
def start_scheduler(app, socketio):
    ...
    # NEW: Schedule synchronized collection every 5 minutes
    scheduler.add_job(synchronized_collection_job, 'interval', minutes=5)
    ...
    logger.info("Starting scheduler with 5-minute synchronized collection intervals")
